                        ...
                        <div className='xl:w-[670px]'>
                            ...
                            <ul className="pl-4">
                                <li className="text_para">
                                    1. Scheduled the appointment directly.
                                </li>
                                <li className="text_para">
                            ...
                            <div className='w-[150px] lg:w-[248px] bg-white absolute bottom=[50px] left-0 md:bottom-[100px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]'>
                                <div className='flex items-center justify-between'>
                                    <div className='flex items-center gap-[6px] lg:gap-3'>
                                        ...
                                        <p className='text-[10px] leading-[10px] lg:text-[14px] lg:leading-5 text-textColor font-[400]'>10:00AM
                                        </p>
                                    </div>
                                ...
                                <div className='flex items-center gap-[6px] lg:gap[10px] mt-2 lg:mt-[18px]'>
                                    ...
                                    <h4 className='text-[10px] leading-3 lg:text-[16px] lg:leading-[22px] font-[700] text-headingColor'>Wayne Collis</h4>
                                </div>
                            </div>
                        </div>
                    </div>
