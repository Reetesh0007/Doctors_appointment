    ...
    <section>
      <div className='px-4 mx-auto max-w-screen-md'>
        ...
        <p className='mb-8 lg:mb-16 font-light text-center text_para'>
          Got a technical issue?Want to send feedback about beta feature? Let us know.</p>
          ...
          <form action="#" className='space-y-8'>
            ...
            <div>
              ...
              <input type="text" id='subject' placeholder='Let us know we can help you' className='form_input mt-1' />
            </div>
